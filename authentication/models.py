...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    # verified by an email. For users who have not verified their emails the flag
    # will be false.
    is_verified = models.BooleanField(default=False)

    # idle time for automatic logoff on clients

    max_idle_time = models.IntegerField(default=10)
